...
$adkfolder = 'C:\Program Files (x86)\Windows Kits\10\'
$bitversion = "amd64"
...
$dhcptoolfile = "C:\download\dhcptest-0.5-win64.exe"
  ...
  #ADK download v10
  #grabbed this content from:
  #https://github.com/p0w3rsh3ll/ADK
  $adkMainURL ="http://download.microsoft.com/download/8/1/9/8197FEB9-FABE-48FD-A537-7D8709586715/adk/"
